...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_night_teleport_solo = QtWidgets.QLabel(self.centralwidget)
        self.label_night_teleport_solo.setGeometry(QtCore.QRect(30, 320, 60, 20))
        ...
        self.checkBox_night_teleport.setText("TP5")
        ...
        self.checkBox_night_teleport_solo = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_night_teleport_solo.setGeometry(QtCore.QRect(100, 320, 40, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.checkBox_night_teleport_solo.setFont(font)
        self.checkBox_night_teleport_solo.setObjectName("checkBox_night_teleport_solo")
        self.checkBox_night_teleport_solo.setText("TP1")
        self.checkBox_night_teleport_solo.setStyleSheet("background: none;")
        self.checkBox_night_teleport_solo.setToolTip('Летает на свободный телепорт каждые 12 минут. '
                                                     'Свободный телепорт должен быть на F11')
        self.checkBox_night_teleport_solo.stateChanged.connect(self.toggle_night_teleport_solo)
